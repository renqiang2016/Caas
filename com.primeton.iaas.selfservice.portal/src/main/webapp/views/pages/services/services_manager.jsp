...
<script src="<%=contextPath%>/views/pages/services/js/services_manager.js"></script>
	...
	<div class="row">
		<div class="col-md-12 portlet light ">
			<div class="table-container">
				...
				<table class="table table-striped table-bordered table-hover" id="pageServicesGrid">
					<thead>
						<tr role="row">
